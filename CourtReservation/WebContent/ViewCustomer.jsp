                        ...
                        <div class="col mb-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                   <c:forEach items="${customer}" var="customer" begin="0" varStatus="count">
                                        <tr>
							            ...
							            <td><c:out value="${customer.custemail}" /></td>
							             <td><c:out value="${customer.custpass}" /></td>
							             <td><c:out value="${customer.custphone}" /></td>
                                            <td><a href="UpdateCustomerController?action=update&custid=<c:out
            value="${customer.custid}" />" class="w3-btn w3-green w3-round-large" >Update</a></td>
              <td><a href="DeleteCustomerController?action=delete&custid=<c:out
            value="${customer.custid}" />" class="w3-btn w3-red w3-round-large">Delete</a></td>
                                        </tr>
                                        </c:forEach>
