                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
			                    ...
			                    <input type="text" class="form-control form-control-user" name="cid"  title="bookingID" placeholder="Court's ID" value="<c:out value="${court.cid}"/>" required>
			                  </div>
                                <div class="form-group">
			                    <input type="text" class="form-control form-control-user" name="cname"  placeholder="Court'S Name" value="<c:out value="${court.cname}"/>" required>
			                  </div>
			                  <div class="form-group">
			                    <input type="text" class="form-control form-control-user" name="status"  placeholder="Status" value="<c:out value="${court.status}"/>" required>
			                  </div>
