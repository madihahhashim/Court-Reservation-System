                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                               ...
                               <div class="form-group">
			                    <input type="text" class="form-control form-control-user" name="custname"  pattern="^[a-zA-Z/@/-/./'/\s ]+$" title="Name should only contain letters,@,',- . e.g. john" placeholder="Customer's Name" value="<c:out value="${customer.custname}"/>" required>
			                  </div>
			                  <div class="form-group">
			                    <input type="textarea" class="form-control form-control-user" name="custaddress"  placeholder="Address"  value="<c:out value="${customer.custaddress}"/>" required>
			                  </div>
			                  <div class="form-group">
