                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">View Court</h6>
                                </div>
                                <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                   <c:forEach items="${court}" var="court" begin="0" varStatus="count">
                                        <tr>
                                        <td><c:out value="${court.cid}"/></td>
                                        <td><c:out value="${court.cname}" /></td>
							            <td><c:out value="${court.status}" /></td>
                                            <td><a href="UpdateCourtController?action=update&cid=<c:out
            value="${court.cid}" />" class="w3-btn w3-green w3-round-large" >Update</a></td>
              <td><a href="DeleteCourtController?action=delete&cid=<c:out
            value="${court.cid}" />" class="w3-btn w3-red w3-round-large">Delete</a></td>
                                        </tr>
                                        </c:forEach>
