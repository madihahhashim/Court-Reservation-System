                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                   ...
                                   <c:forEach items="${booking}" var="booking" begin="0" varStatus="count">
                                        <tr>
                                        <td><c:out value="${booking.bookid}"/></td>
                                        <td><c:out value="${booking.custid}" /></td>
							            <td><c:out value="${booking.bookdate}" /></td>
							            <td><c:out value="${booking.booktime}" /></td>
							            <td><c:out value="${booking.hours}" /></td>
							            <td><c:out value="${booking.totalprice}" /></td>
							             <td><c:out value="${booking.cid}" /></td> 
							            <td><c:out value="${booking.adminid}" /></td>
                                            <td><a href="UpdateBookingController?action=update&bookid=<c:out
            value="${booking.bookid}" />" class="w3-btn w3-green w3-round-large" >Update</a></td>
              <td><a href="DeleteBookingController?action=delete&bookid=<c:out
            value="${booking.bookid}" />" class="w3-btn w3-red w3-round-large">Delete</a></td>
                                        </tr>
                                        </c:forEach>
