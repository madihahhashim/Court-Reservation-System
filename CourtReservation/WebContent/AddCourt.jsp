                    ...
                    <div class="row">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
			                    ...
			                    <input type="text" class="form-control form-control-user" name="cid"  placeholder="COURT'S ID" required>
			                  </div>
                               <div class="form-group">
			                    <input type="text" class="form-control form-control-user" name="cname" maxlength="12" placeholder="COURT'S NAME"   required>
			                  </div>
			                  <div class="form-group">
			                    <input type="text" class="form-control form-control-user" name="status"  placeholder="STATUS"   required>
			                  </div>
